...
# Fetch metadata about the org that's created by the org capability
data "aws_organizations_organization" "main" {}

locals {
  # Keys of accounts in the org. The list is ingested from a file (as opposed to derived
  # from data.aws_organizations_organization.main) because it needs to be known at plan
  # time to be used in the for_each meta-argument of resource declarations. This is the
  # same file used by the org capability to create accounts.
